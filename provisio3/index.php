        ...
        <div class="row">
          <div class="col-12">
            <nav class="navbar navbar-expand-lg bg-white">
              <div class="container-fluid">
                <a class="navbar-brand nav-bar" href="index.php"
                  ><img class="img-fluid" src="images/provisiologo.svg"
                /><h2>Hello, <?php echo $user_data['firstName']; ?></h2></a>
                <button
                ...
                <div
                  class="collapse navbar-collapse navbar-nav-custom"
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-5">
            <div class="manage-reservation-img">
              <a href="#"
                ...
                <img
                  class="img-fluid"
                  src="images/manage-reservation-img-new.png"
                />
              </a>
            </div>
          </div>
