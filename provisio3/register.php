    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        if(!empty($username) && !empty($password) && !is_numeric($username)){
            ...
            //insert into the columns of the database in the order the tables are written. 
                //!!!!ORDER MATTERS!!!!!
            $query = "insert into users (userID,username,password,email,firstName,lastName,proPoints) values ('$userID','$username','$password','$email','$firstName','$lastName','$proPoints')";
                    	...
                    	<form class="row g-3">
                          ...
                          <div class="custom-form">
                            ...
                            <input type="password" class="form-control" id="InputPassword1">
                          	...
                          	<div class="response-text">Password must contain numbers;</div>
                            <div class="response-text">Password must contain uppercase letters;</div>
                            <div class="response-text">Length must be greater than 8 characters.</div>
                        </form>
                    </div>
